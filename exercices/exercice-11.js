...
if(panier > 200 && panier <=500){
    console.log(`Cout final: ${panier} DH, livraison: gratuit`);
}
else if(panier > 500){
    panier = panier * 0.9;
    console.log(`Cout final(reduction 10%): ${panier} DH, livraison: Gratuit`)
}
else {
    console.log(`Cout final: ${panier} DH, livraison: pas Gratuit`)
}